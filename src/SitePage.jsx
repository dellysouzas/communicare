  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      ...
      <footer className="w-full bg-[#4c3e92] text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center md:justify-items-center">
            {/* Coluna 1: Logo e Descrição */}
            <div className="space-y-4 text-center md:text-center">
              <img src="/logos/Branca.png" alt="Communicare" className="h-28 w-auto mb-2 mx-auto" />
              <p className="text-white/80 text-sm leading-relaxed">
                Uma clínica especialista no desenvolvimento humano interdisciplinar, reunindo diversas especialidades que atuam juntas em busca do progresso da criança e do adolescente. Somos um ambiente de acolhimento emocional, experiências sensoriais e visão global.
              </p>
            </div>
            
            {/* Coluna 2: Contatos e Ícones */}
            <div className="space-y-4 text-center md:text-center">
              <h3 className="text-lg font-semibold font-title">Fale agora mesmo</h3>
              <ul className="space-y-3">
                <li className="text-white/70">
                  <a href="https://wa.me/5581998660984" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-200 flex items-center justify-center space-x-2">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
                    </svg>
                    <span>(81) 99866-0984</span>
                  </a>
                </li>
                <li className="text-white/70">
                  <a href="mailto:communicare@greciacalado.com.br" className="hover:text-white transition-colors duration-200 flex items-center justify-center space-x-2">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                    </svg>
                    <span>communicare@greciacalado.com.br</span>
                  </a>
                </li>
              </ul>
            ...
            <div className="space-y-4 text-center md:text-center">
              <h3 className="text-lg font-semibold font-title">Quer nos visitar?</h3>
              <div className="space-y-3">
                <p className="text-white/70 text-sm">
                  R. João Cardoso Aires, 555, Boa Viagem, Recife/PE
                </p>
                <a 
                  href="https://maps.app.goo.gl/ubbRa5pxMVYxFRxv5" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block w-full h-48 bg-white/10 rounded-lg overflow-hidden hover:bg-white/20 transition-colors duration-200"
                >
                  <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3950.123456789!2d-34.9012345!3d-8.1234567!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zOMKwMDcnMjQuNCJTIDM0wrA1NCc0NC40Ilc!5e0!3m2!1spt-BR!2sbr!4v1234567890123!5m2!1spt-BR!2sbr"
                    width="100%" 
                    height="100%" 
                    style={{border: 0}} 
                    allowFullScreen="" 
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="inline-flex items-center justify-center text-white/70 hover:text-white transition-colors duration-200 text-sm"
                >
          ...
          <div className="mt-8 pt-8 border-t border-white/20 text-center">
            <p className="text-white/60 text-sm">
              © 2025 Communicare Clínica. Desenvolvido por <a href="https://nivaresearch.com/" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors duration-200 underline">Niva Research</a>. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </footer>
