    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="hero" className="w-full min-h-screen bg-gradient-to-br from-[#009db0] to-[#a1d6dc] flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center text-white">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8" style={{ fontFamily: 'Century Gothic Paneuropean, Century Gothic, Arial, sans-serif' }}>
            Vídeo do Slogan
          </h1>
      ...
      <section id="quem-somos" className="w-full py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#4c3e92] mb-6" style={{ fontFamily: 'Century Gothic Paneuropean, Century Gothic, Arial, sans-serif' }}>
              Quem Somos
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h3 className="text-2xl font-semibold text-[#4c3e92]" style={{ fontFamily: 'Century Gothic Paneuropean, Century Gothic, Arial, sans-serif' }}>
                Título da Seção
              </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-[#4c3e92] mb-4" style={{ fontFamily: 'Century Gothic Paneuropean, Century Gothic, Arial, sans-serif' }}>
                Diferencial 1
              </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg border border-[#a1d6dc] p-8 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-[#4c3e92] mb-4 text-center" style={{ fontFamily: 'Century Gothic Paneuropean, Century Gothic, Arial, sans-serif' }}>
                Serviço 1
              </h3>
              <div className="space-y-2">
                <div className="w-full h-3 bg-gray-200 rounded"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-lg font-semibold text-[#4c3e92] mb-2" style={{ fontFamily: 'Century Gothic Paneuropean, Century Gothic, Arial, sans-serif' }}>
                Profissional 1
              </h3>
      ...
      <section id="contato" className="w-full py-16 md:py-24 bg-gradient-to-br from-[#009db0] to-[#a1d6dc]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6" style={{ fontFamily: 'Century Gothic Paneuropean, Century Gothic, Arial, sans-serif' }}>
              Contato
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-semibold text-white mb-6" style={{ fontFamily: 'Century Gothic Paneuropean, Century Gothic, Arial, sans-serif' }}>
                Entre em Contato
              </h3>
              <div className="space-y-4">
                <div className="flex items-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
              <h3 className="text-xl font-semibold text-white mb-6" style={{ fontFamily: 'Century Gothic Paneuropean, Century Gothic, Arial, sans-serif' }}>
                Envie uma Mensagem
              </h3>
              <div className="space-y-4">
      ...
      <footer className="w-full bg-[#4c3e92] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            {/* Links Rápidos */}
            <div>
              <h4 className="text-lg font-semibold mb-4" style={{ fontFamily: 'Century Gothic Paneuropean, Century Gothic, Arial, sans-serif' }}>
                Links Rápidos
              </h4>
              <div className="space-y-2">
